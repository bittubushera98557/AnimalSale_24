...
// create and show the alert dialog
    ...
    private fun checkEditFieldValues() {
     ...
     utilities.snackBar(fl_fieldsFrag,"Choose a currency type")
            ...
            else  if (et_petType.visibility == View.VISIBLE && (TextUtils.isEmpty(strPetType.replace(" ".toRegex(), "")))) {
            ...
            if (et_age.visibility == View.VISIBLE && (TextUtils.isEmpty(
                        strAge.replace(
                                " ".toRegex(),
                                ""
                        )
            ...
            fiedlValueChk = false
                ...
                if (et_desc.visibility == View.VISIBLE && (TextUtils.isEmpty(
                        strDesc.replace(
                                " ".toRegex(),
                                ""
                        )
            ...
            fiedlValueChk = false
                    ...
                    if (TextUtils.isEmpty(
                        ...
                        focusOnEditTxtView(et_area, "Enter Location Area")
                        fiedlValueChk = false
                    }
