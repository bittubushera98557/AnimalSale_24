...
var strInfo=""
   ...
   if( it1.images.size>0) {
    ...
    private fun testAddPetApi() {
      val call = service!!.addNewPetWithOutImgApi("Dog" ,"desi","jacky","Black white Dog","German", "3.5","300","test from app","yes","","",""+SharedPrefUtil.getUserId(context)).enqueue(object : Callback<AllApiResponse.CommonRes> {
