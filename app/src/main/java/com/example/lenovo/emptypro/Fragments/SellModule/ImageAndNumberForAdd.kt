...
petID:*/
        ...
        Log.e(TAG+" addNewPetApi","mainCat="+addNewAdvertiseRequestParam!!.CatName+
                ...
                "&action="+"&petID="+"&userID="+SharedPrefUtil.getUserId(context))
        service!!.addNewPetWithOutImgApi(

                "" + addNewAdvertiseRequestParam!!.CatName,
